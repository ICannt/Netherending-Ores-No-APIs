...
public enum BlockDataOreEndModded2 implements IStringSerializable {
    ...
    RUBY_ORE ("ruby_ore", 0, 2, 3, 15, EnumRarity.COMMON),
    SAPPHIRE_ORE ("sapphire_ore", 0, 2, 3, 15, EnumRarity.COMMON),
    PERIDOT_ORE ("peridot_ore", 0, 2, 3, 15, EnumRarity.COMMON),
    ELECTROTINE_ORE ("electrotine_ore", 0, 2, 3, 15, EnumRarity.COMMON),
    AMBROSIUM_ORE ("ambrosium_ore", 6, 0, 3, 15, EnumRarity.COMMON),
    GRAVITITE_ORE ("gravitite_ore", 0, 2, 3, 15, EnumRarity.COMMON),
    ZANITE_ORE ("zanite_ore", 0, 1, 3, 15, EnumRarity.COMMON),
    ARKENIUM_ORE ("arkenium_ore", 0, 2, 3, 15, EnumRarity.COMMON),
