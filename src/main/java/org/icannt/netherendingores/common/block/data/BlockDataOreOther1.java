...
public enum BlockDataOreOther1 implements IStringSerializable {
    ...
    END_ARDITE_ORE ("end_ardite_ore", 0, 4, 10, 50, EnumRarity.COMMON),
    ...
    OVERWORLD_AMBROSIUM_ORE ("overworld_ambrosium_ore", 6, 0, 3, 15, EnumRarity.COMMON),
    OVERWORLD_GRAVITITE_ORE ("overworld_gravitite_ore", 0, 2, 3, 15, EnumRarity.COMMON),
    OVERWORLD_ZANITE_ORE ("overworld_zanite_ore", 0, 1, 3, 15, EnumRarity.COMMON),
    OVERWORLD_ARKENIUM_ORE ("overworld_arkenium_ore", 0, 2, 3, 15, EnumRarity.COMMON),
    OVERWORLD_ICESTONE_ORE ("overworld_icestone_ore", 0, 1, 3, 15, EnumRarity.COMMON);
